...
(Sections~\ref{sec:qualitative}--\ref{sec:percat}) together with the RTFM
baseline-reproduction investigation summarized in Section~\ref{sec:lim-gaps}; and (c)~the
complete test-time-adaptation investigation---the six-strategy search, the NORM/CORAL
eliminations, and the episodic-inertness diagnosis (Chapter~\ref{ch:06}, Section~\ref{sec:coral}).
...
Chapter~\ref{ch:08} states limitations and future work, and Chapter~\ref{ch:09} concludes.
