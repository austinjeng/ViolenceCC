...
nuisances (clothing, background, lighting), and has been explored for anomaly detection in
constrained settings~\cite{doshi2022skeleton}. This complementarity---semantic appearance from a
...
separate line of work~\cite{doshi2022skeleton}, but the integration of skeleton dynamics with
vision-language features in a unified weakly supervised framework remains largely unexplored.
...
This thesis makes three contributions, extending the study reported in our CGW~'26 workshop paper.
...
$+13.2$ points in the single most-degraded condition), while leaving the model bit-identical to the
source model wherever adaptation would be unsafe.
