...
MGFN~\cite{chen2023mgfn} (79.19\%), % RE-VERIFY: MGFN XD = 79.19 is the I3D variant (NOT the VideoSwin 80.11); UCF 86.98 is I3D
...
86.97\%, MGFN 86.98\%,
CLIP-TSA~\cite{joo2023cliptsa} 87.58\%), % RE-VERIFY: CLIP-TSA XD = 82.19 (primary paper); VadCLIP's table lists 82.17 (0.02 drift)
...
(64.04\% % RE-VERIFY: EventVAD XD = 64.04 (AP), NOT 87.51 (its XD ROC-AUC)
/ 62.01\% % RE-VERIFY: LAVAD XD = 62.01 (AP), NOT 85.36 (its XD ROC-AUC)
vs 78.7\%), at a far higher inference budget.
