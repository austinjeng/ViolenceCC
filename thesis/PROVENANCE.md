...
| `thesis/figures/fig_temporal_scores.pdf` | figure | Class V | byte-identical to `paper/figures/fig_temporal_scores.pdf` (cmp exit 0); generator `scripts/generate_pub_figures.py` | verified 2026-07-05: curve video is RoadAccidents127 (RoadAccidents), matching the frozen paper caption (paper/main.tex L268–273); generated by the tracked generator from local eval_scores.npz |
